...
# Kill any running processes on ports 5001 and 5173
echo "Shutting down any existing processes..."
lsof -ti:5001 | xargs kill -9 2>/dev/null || true # Changed from 5000 to 5001
...
echo "Backend: http://localhost:5001" # Updated for clarity
